...
const refundPolicy = () => {
  return (
    <div>
      <h2 style={{fontSize:'2.5rem'}}>Refund Policy</h2>
      <p style={{fontSize:'1rem'}}>

      Astro75 believes in helping its customers as far as possible, and has therefore a liberal cancellation policy. Under this policy:
...
astro75 does not accept cancellation requests for perishable items like flowers, eatables etc. However, refund/replacement can be made if the customer establishes that the quality of product delivered is not good.
...
In case of any Refunds approved by the astro75, it’ll take 6-8 days for the refund to be processed to the end customer.</p>
    </div>
  );
};
